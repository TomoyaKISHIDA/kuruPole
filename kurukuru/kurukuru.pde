...
class Stage{
  ...
  boolean hit(int px, int py, float t){
    println(cos(t));
    if((x*4+30*cos(t) <= px && px <= x*4+w*4+30*cos(t)) 
    || x*4-30*cos(t) <= px && px <= x*4+w*4-30*cos(t)){
      if((y*4+30*sin(t) <= py && py <= y*4+h*4+30*sin(t))
      || y*4-30*sin(t) <= py && py <= y*4+h*4-30*sin(t)){
        return true;
      }else{
        return false;
      }
